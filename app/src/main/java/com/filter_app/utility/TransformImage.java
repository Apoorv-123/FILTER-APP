...
/**
 * Created by Apoorv on 23-Feb-18.
 */
...
public class  TransformImage {
    ...
    public Bitmap applyVignetteSubFilter(int vignette){
        com.zomato.photofilters.imageprocessors.Filter myFilterVignette = new com.zomato.photofilters.imageprocessors.Filter();
    ...
    public Bitmap applySaturationSubFilter(int saturation){
        com.zomato.photofilters.imageprocessors.Filter myFilterSaturation = new com.zomato.photofilters.imageprocessors.Filter();
    ...
    public Bitmap applyContrastSubFilter(int contrast){
        com.zomato.photofilters.imageprocessors.Filter myFilterContrast = new com.zomato.photofilters.imageprocessors.Filter();
